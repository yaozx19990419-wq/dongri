...
const faqs = [
  ...
  },
  {
    question: "如何获取成人内容补丁？",
    answer:
      "Steam版本为全年龄版本。若需要成人内容，请在购买后前往官方网站或相关社区查找补丁资源。请注意，补丁仅供18岁以上玩家使用。",
  },
  {
    question: "游戏可以存档吗？",
    answer: "可以。游戏支持多个存档位，你可以随时保存和加载进度。Steam版本还支持云存档功能。",
  },
  {
    question: "是否需要玩过《夏日狂想曲》？",
    answer: "不需要。虽然《冬日狂想曲》是《夏日狂想曲》的续作，但可以独立游玩。玩过前作会有更好的体验，但不是必须的。",
  },
  {
    question: "通关大概需要多长时间？",
    answer:
  ...
  {
    question: "游戏有多个结局吗？",
    answer: "是的，游戏根据你与不同角色的互动和好感度，会有多个不同的结局。每个主要角色都有独立的故事线和结局。",
  },
  {
    question: "如何解锁所有CG？",
    answer:
    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">关于游戏下载和游玩的常见问题解答</p>
        </div>
