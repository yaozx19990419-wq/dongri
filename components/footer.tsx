    ...
    <footer className="bg-card border-t-4 border-border mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b-2 border-border pb-2">快速导航</h3>
          ...
          {/* External Links */}
          <div className="space-y-4">
            <h3 className="font-bold text-lg border-b-2 border-border pb-2">相关链接</h3>
            <ul className="space-y-2">
              <li>
                <a
              ...
              <li>
                <a href="#" className="hover:text-primary transition-colors flex items-center gap-1">
                  官方推特 <ExternalLink className="w-3 h-3" />
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-6 border-t-2 border-border text-center text-muted-foreground">
          ...
          <p className="text-sm mt-2">本站为游戏爱好者制作的非官方网站</p>
        </div>
      </div>
    </footer>
  )
